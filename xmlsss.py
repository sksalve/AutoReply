...
def main():
    ...
    Log = "C:\\Users\\sachin\\Desktop\\xmlwatcher\\Log"  # maintains log file here
    ...
    dst_path = "C:\\Users\\sachin\\Desktop\\xmlwatcher\\Archive"
    ...
    retry = "C:\\Users\\sachin\\Desktop\\xmlwatcher\\Retry"
    if not os.path.exists(retry):
        os.mkdir(retry)

    error_path = "C:\\Users\\sachin\\Desktop\\xmlwatcher\\Error"
                ...
                try:
                    ...
                    while True:
                        ...
                        connection = pypyodbc.connect(
                            'Driver={SQL Server};''Server=DESKTOP-4KMV1SO\sqlexpress;''Database=Fax_Ocean;''uid=sa;pwd=OceanFax!')
                        if True:
